...
public class Resources {
    ...
    static String customer1JSON = "{\"Username\":\"rets\",\"Password\":\"abc123abc\",\"Firstname\":\"dimos\",\"Lastname\":\"retsidis\",\"Email\":\"dimos60100@csd.uoc.gr\","
            + "\"Number\":\"4040404040404040\",\"Expiredate\":\"06/30\",\"Securitycode\":\"300\"}";

    static String event1JSON = "{\"Name\":\"Rets Event\",\"Date\":\"2024-11-15\",\"Time\":\"2024-11-15 18:00:00\",\"Type\":\"Ouaou\",\"Capacity\":\"200\",\"VipN\":\"50\","
            + "\"NormalN\":\"150\",\"VipP\":\"150\",\"NormalP\":\"50\"}";

    static String event2JSON = "{\"Name\":\"Rets Mplaaa\",\"Date\":\"2024-11-15\",\"Time\":\"2024-11-15 18:00:00\",\"Type\":\"Ouaou\",\"Capacity\":\"200\",\"VipN\":\"50\","
            + "\"NormalN\":\"150\",\"VipP\":\"150\",\"NormalP\":\"50\"}";


    static String reservation1JSON = "{\"CustomerId\":\"0\",\"EventId\":\"0\",\"TicketId\":\"1\",\"NumTickets\":\"5\",\"ReservetionDate\":\"2024-11-05\",\"TotalPrice\":\"250\"}";
    static String reservation2JSON = "{\"CustomerId\":\"0\",\"EventId\":\"1\",\"TicketId\":\"2\",\"NumTickets\":\"5\",\"ReservetionDate\":\"2024-11-05\",\"TotalPrice\":\"500\"}";
    ...
    String createJsonTicketFromEvent(int TicketId, int EventId, String Type, int Price, int Availability) {
        return "Hello World";
    }
;
}
